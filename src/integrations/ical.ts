...
class ICal implements Base {
    ...
    icon = `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      <g>
        ...
        <path d="M255.9,110.4c1.4-36.4,18.4-64.2,47.3-85.3C318.1,14.1,335,7.9,353.1,4.6c3.9-0.7,4.9,0.4,4.9,4.2   c0.3,41.6-16.9,74.4-50.1,98.6c-13.4,9.8-29.3,14-46.1,13.8c-4.5,0-6.5-1.2-5.9-5.9C256.1,113.7,255.9,112,255.9,110.4z" style="fill-opacity: 0.65;"/>
      </g>
    </svg>`
    online = false
